...
public class AddSupplierScreen extends javax.swing.JFrame {
   ...
   private JTextField supplierTypeField;
   private JButton saveButton;
    ...
    setTitle("Add Supplier");
        ...
        supplierNameField.setBounds(150, 50, 200, 30);
        add(supplierNameField);

        JLabel typeLabel = new JLabel("Supplier Type:");
        typeLabel.setBounds(50, 100, 100, 30);
        add(typeLabel);

        supplierTypeField = new JTextField();
        supplierTypeField.setBounds(150, 100, 200, 30);
        add(supplierTypeField);
    ...
    private void saveSupplier() {
        ...
        // حفظ المورد
        // طباعة البيانات المدخلة للتأكيد
    System.out.println("Supplier Name: " + name);
    System.out.println("Supplier Type: " + type);

    // استخدام Factory لإنشاء منتج (كمثال)
    Product newProduct = ProductFactory.createProduct("Electronics", name, 1500.00);
    Product product2 = ProductFactory.createProduct("Furniture", "Chair", 120.0);
    product2.displayDetails(); // Furniture: Chair | Price: 120.0 
    newProduct.displayDetails();

    // رسالة تأكيد
    JOptionPane.showMessageDialog(this, "Supplier saved successfully!");
        JOptionPane.showMessageDialog(this, "Supplier Saved: " + name + ", " + type);
